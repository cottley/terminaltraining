                ...
                children: {
                    ...
                    'etc': { 
                        ...
                        children: {
                            ...
                            'sysctl.conf': { type: 'file', permissions: '-rw-r--r--', owner: 'root', group: 'root', size: 449, content: '# Oracle 19c kernel parameters\nfs.aio-max-nr = 1048576\nfs.file-max = 6815744\nkernel.shmall = 2097152\nkernel.shmmax = 536870912\nkernel.shmmni = 4096\nkernel.sem = 250 32000 100 128\nnet.ipv4.ip_local_port_range = 9000 65500\nnet.core.rmem_default = 262144\nnet.core.rmem_max = 4194304\nnet.core.wmem_default = 262144\nnet.core.wmem_max = 1048576' },
                            'security': { type: 'directory', permissions: 'drwxr-xr-x', owner: 'root', group: 'root', size: 4096, children: {
                                'limits.conf': { type: 'file', permissions: '-rw-r--r--', owner: 'root', group: 'root', size: 2048, content: '# Oracle 19c resource limits\noracle soft nproc 2047\noracle hard nproc 16384\noracle soft nofile 1024\noracle hard nofile 65536\noracle soft stack 10240\noracle hard stack 32768' }
                            }}
                        }
                    },
                    'home': { 
